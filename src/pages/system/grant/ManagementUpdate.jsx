                ...
                <form>
                    ...
                    <fieldset className='limitArea'>
                        ...
                        <div className='timeArea'>
                            <Select name={'time-hour'} current={inputs.connect_limit_start_time_hour} setInputs={setInputs} onChange={(e)=>inputChange(e, setInputs)} changeName='connect_limit_start_time_hour' disabled={inputs.connect_limit_yn === 'y' ? false: true}/>
                            <Select name={'time-minute'} current={inputs.connect_limit_start_time_minute} setInputs={setInputs} onChange={(e)=>inputChange(e, setInputs)} changeName='connect_limit_start_time_minute' disabled={inputs.connect_limit_yn === 'y' ? false: true}/>
                            -
                            <Select name={'time-hour'} current={inputs.connect_limit_end_time_hour} setInputs={setInputs} onChange={(e)=>inputChange(e, setInputs)} changeName='connect_limit_end_time_hour' disabled={inputs.connect_limit_yn === 'y' ? false: true}/>
                            <Select name={'time-minute'} current={inputs.connect_limit_end_time_minute} setInputs={setInputs} onChange={(e)=>inputChange(e, setInputs)} changeName='connect_limit_end_time_minute' disabled={inputs.connect_limit_yn === 'y' ? false: true}/>
                        </div>
